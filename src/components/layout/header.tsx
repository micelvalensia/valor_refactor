        ...
        <div className="bg-[#0F0F0F] w-full hidden lg:block p-5 border-b border-white/20">
            ...
            <div className="hidden md:flex text-white items-center justify-between">
                ...
                <div className="w-[40%] max-w-175 relative">
                    <Input className="rounded-sm border-0 bg-[#232229] pl-10" placeholder="Search Problems or Projects..." />
                    <Search className="absolute left-2 top-1.5 text-white/30" size={20} />
                </div>

                {/* Menu */}
                <div className="flex items-center gap-3">
                    <div className="bg-[#38C67A] w-10 h-10 rounded-full"></div>
                    <Button className="bg-[#38C67A] hover:bg-emerald-500 text-white font-bold py-6 rounded-lg text-base transition-colors"
