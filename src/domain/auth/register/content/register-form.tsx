...
import { useResgister } from "../hooks/use-register"
...
export function RegisterForm() {
    const { form, onSubmit, isLoading } = useResgister()
    const [showPassword, setShowPassword] = useState(false)
    return (
        <div className="w-full sm:max-w-md md:max-w-[80%] md:min-h-[80%] space-y-10 flex flex-col justify-center">
            <div className="flex flex-col space-y-4 text-center md:text-left">
                <h1 className="text-white text-4xl md:text-5xl font-bold tracking-wider">
                    CREATE YOUR ACCOUNT
                </h1>
                <p className="text-white">Start your <span className="text-main">dev journey</span></p>
            </div>

            <form onSubmit={onSubmit} className="space-y-6 lg:mt-10">
                ...
                <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-main hover:bg-emerald-500 text-white font-bold py-6 rounded-lg text-base mt-8 transition-colors"
                >
            ...
            <p className="text-gray-400 text-sm mt-6">
                ...
                <Link href="/auth/sign-in" className="text-main hover:text-emerald-300 transition-colors">
                    Sign In
                </Link>
            </p>
        </div>
